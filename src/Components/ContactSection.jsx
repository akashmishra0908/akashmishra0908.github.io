...
export function ContactSection() {
  ...
  const handleOnSubmit = (e) => {
    ...
    emailjs.sendForm('service_p1udg6l', 'template_7p56djg', e.target, 'eaaEFalt0JtnCUZ-X')
    .then(
      (result) => {
    ...
    <div className={styles.rootCont} id="contact">
      ...
      <Form onSubmit={handleOnSubmit}>
        ...
        <div className={styles.iconsCont}>
          <a href="mailto:m.official0908@gmail.com">
            <AiOutlineMail className={styles.emailicon} />
          </a>
          <a
            href="https://www.linkedin.com/in/akash-mishra-a0955521a/"
            target="_blank"
            rel="noreferrer"
          >
            <AiFillLinkedin className={styles.linkedInIcon} />
          </a>
          <a href="https://github.com/akashmishra0908" rel="noreferrer" target="_blank">
            <AiOutlineGithub className={styles.gitIcon} />
          </a>
        </div>
        <p className={styles.text}>Phone: 7800402726</p>{" "}
        <p className={styles.text}>Email: m.official0908@gmail.com</p>
      </Fade>
    </div>
  )
}
